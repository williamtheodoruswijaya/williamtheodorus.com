...
const About = () => {
  return (
    <section
      id="about"
      className="relative bg-black flex flex-col items-center justify-center gap-12 z-10 py-20 md:py-40 overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-10 md:gap-16">
        ...
        >
          <div className="text-gray-300 text-lg md:text-xl leading-relaxed text-justify">
            <p>Hello! I&apos;m William,</p>
            <p>
              A developer based in Indonesia with a deep passion for both the
              analytical world of Data Science and the creative challenges of
              Software Engineering. My journey in tech is driven by the thrill
              of transforming complex data into understandable stories and
              building applications that are both functional and delightful to
              use.
            </p>
            <p>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="flex flex-col items-center gap-2 text-gray-300 hover:text-cyan-400 transition-colors duration-300"
            >
              {skill.icon}
